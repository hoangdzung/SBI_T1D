...
class MAP:
    ...
    def twin(self,
        ...
        neg_log_posterior_func = model.neg_log_posterior_extended if getattr(model, "extended", False) and hasattr(model, "neg_log_posterior_extended") else model.neg_log_posterior
        ...
        if getattr(model, "extended", False):
            if 'SI_B2' in draws:
                del draws['SI_B2']
            if 'kabs_B2' in draws:
                del draws['kabs_B2']
